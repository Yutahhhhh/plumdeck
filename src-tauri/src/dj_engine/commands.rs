...
pub enum JunctionOperation {
    ...
    #[serde(rename = "turn.join")] TurnJoin,
    #[serde(rename = "turn.leave")] TurnLeave,
    #[serde(rename = "turn.repeat")] TurnRepeat,
    #[serde(rename = "turn.failover")] TurnFailover,
    #[serde(rename = "turn.onair")] TurnOnAir,
    #[serde(rename = "turn.force")] TurnForce,
    #[serde(rename = "turn.skip")] TurnSkip,
    #[serde(rename = "turn.release")] TurnRelease,
    #[serde(rename = "turn.cue")] TurnCue,
...
impl JunctionOperation {
    fn wire(&self) -> &'static str {
        match self {
            ...
            Self::PeerApprove => "peer.approve",
            Self::ProfileUpdate => "profile.update", Self::RosterReorder => "roster.reorder",
            Self::SessionStart => "session.start",
            Self::RecoveryResume => "recovery.resume",
            Self::TurnJoin => "turn.join", Self::TurnLeave => "turn.leave", Self::TurnRepeat => "turn.repeat",
            Self::TurnFailover => "turn.failover", Self::TurnOnAir => "turn.onair", Self::TurnForce => "turn.force",
            Self::TurnSkip => "turn.skip", Self::TurnRelease => "turn.release", Self::TurnCue => "turn.cue",
