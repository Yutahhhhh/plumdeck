...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "or assist_search (defaults come from the window), or call assist_route when the DJ "
        "names an exact destination track and needs bridge tracks to reach it. Then update the window: "
